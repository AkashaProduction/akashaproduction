...
<section class="page-hero">
    <div class="container grid-2">
        <div>
            ...
            <h1 class="page-title">Suivi client, commandes et support.</h1>
            <p class="lead">Cet espace permet de retrouver les demandes enregistrées, de consulter les tickets et d’échanger avec le service commercial ou technique.</p>
            <div class="panel">
                <ul>
                    <li>Vision des commandes par email</li>
                    <li>Tickets Service commercial et Service technique</li>
                    <li>Zone technique avancée préparée pour la suite</li>
                </ul>
            </div>
        </div>
        <div class="form-card">
            <form class="form-grid" method="post">
                ...
                <div class="field field--full"><label for="lookup-name">Nom du client</label><input id="lookup-name" name="name" value="<?= htmlspecialchars($name, ENT_QUOTES, 'UTF-8'); ?>" required></div>
                <div class="field field--full"><label for="lookup-email">Email client</label><input id="lookup-email" name="email" type="email" value="<?= htmlspecialchars($email, ENT_QUOTES, 'UTF-8'); ?>" required></div>
                <div class="field field--full"><button class="btn btn--primary" type="submit">Ouvrir mon compte</button></div>
            </form>
        </div>
    </div>
</section>
        ...
        <div class="container grid-2">
            <?php foreach ($orders as $order): ?>
                <article class="panel">
                    ...
                    <p class="muted">Référence <?= htmlspecialchars(substr((string) $order['id'], 0, 8), ENT_QUOTES, 'UTF-8'); ?> · <?= htmlspecialchars(date('d/m/Y', strtotime((string) $order['created_at'])), ENT_QUOTES, 'UTF-8'); ?></p>
                    <ul>
    ...
    <section class="section">
        <div class="container grid-2">
            <div class="form-card">
                ...
                <h2 class="section-title">Créer un ticket commercial ou technique</h2>
                <form class="form-grid" method="post">
